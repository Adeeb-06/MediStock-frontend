    ...
    return (
        <>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6 mb-8">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-gray-800/70 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 hover:border-gray-600 cursor-pointer"
                                    style={{
                                        colorScheme: 'dark'
                                    }}
                                />
                                {/* Custom date picker icon overlay */}
                    ...
                    <div className="flex items-end">
                        <button onClick={() => handleApply(startDate, endDate)} className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 group">
          ...
          {['Today', 'This Week', 'This Month', 'Last 30 Days'].map((preset) => (
            <button
              key={preset}
              className="px-3 py-1 text-xs bg-gray-800/50 hover:bg-gray-700/50 text-gray-300 hover:text-white rounded-lg transition-all duration-200 border border-gray-700/50 hover:border-gray-600/50"
            >
              {preset}
            </button>
          ))}
